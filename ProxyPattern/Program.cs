...
namespace ProxyPattern
{
    ...
    //Nesneler ve proxyler için birbirinin yerine kullanılmalarını sağlayan ortak ara birim.
    ...
    public class KorumaliProxy : IKonu
    {
        ...
        public string Talep()
        {
            if (_konu==null)
            {
                return "Protected Proxy: Önce kimlik doğrulamanız gerekmektedir.";
            }
            else
            {
